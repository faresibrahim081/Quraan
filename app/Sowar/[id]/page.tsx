            ...
            <div className="bg-white p-5 rounded-lg">
                <div className="flex items-center mb-[3rem] justify-between flex-wrap">
                    <Link
                        ...
                        className="hidden md:inline-block rounded-md border border-teal-600 bg-teal-600 px-8 py-3 text-ld text-white hover:bg-transparent hover:text-teal-600 focus:ring-3 focus:outline-hidden"
                    ...
                    <Link
                        ...
                        className="md:hidden rounded-md border border-teal-600 bg-teal-600 px-2 py-2 text-md  text-white hover:bg-transparent hover:text-teal-600 focus:ring-3 focus:outline-hidden"
                        href={`/Sowar/${params.id ? Number(params.id) - 1 : ''}`}
                    >
                    ...
                    <Link
                        ...
                        className="hidden md:inline-block rounded-md border border-teal-600 px-8 py-3 text-lg  text-teal-600 hover:bg-teal-600 hover:text-white focus:ring-3 focus:outline-hidden"
                        href={`/Sowar/${params.id ? Number(params.id) + 1 : ''}`}
                    >
                        السورة التالية
                    </Link>
                    <Link
                        ...
                        className="md:hidden rounded-md border border-teal-600 px-2 py-2 text-md  text-teal-600 hover:bg-teal-600 hover:text-white focus:ring-3 focus:outline-hidden"
                        href={`/Sowar/${params.id ? Number(params.id) + 1 : ''}`}
                    >
