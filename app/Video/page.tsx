            ...
            <div id="video" className="w-[80%] mx-auto">
                <div className="text-center mb-6">
                    ...
                    <div className="flex justify-center items-center gap-4 mt-8">
                        <Link
                            className="inline-block whitespace-nowrap rounded-md border border-teal-600 bg-teal-600 px-8 py-3 text-lg text-white hover:bg-transparent hover:text-teal-600 focus:ring-3 focus:outline-hidden"
                            href="" onClick={playVideo('https://win.holol.com/live/quran/playlist.m3u8')}
                        >
                            قناة القران الكريم
                        </Link>
                        <Link
                            className="inline-block whitespace-nowrap rounded-md border border-teal-600 px-8 py-3 text-lg text-gray-800 hover:bg-teal-600 hover:text-white focus:ring-3 focus:outline-hidden"
