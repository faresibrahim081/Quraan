            ...
            <div id="video" className="w-[80%] mx-auto">
                <div className="text-center mb-6">
                    ...
                    <div className="flex justify-center items-center gap-4 mt-8">
                        <Link
                            className="inline-block rounded-md border border-indigo-800 bg-indigo-800 px-12 py-3 text-md font-bold text-white hover:bg-transparent hover:text-indigo-800 focus:ring-3 focus:outline-hidden"
                            href="" onClick={playVideo('https://win.holol.com/live/quran/playlist.m3u8')}
                        >
                            قناة القران الكريم
                        </Link>
                        <Link
                            className="inline-block rounded-md border border-indigo-800 px-12 py-3 text-md font-bold text-indigo-800 hover:bg-indigo-800 hover:text-white focus:ring-3 focus:outline-hidden"
